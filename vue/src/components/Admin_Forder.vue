<template>
  ...
  <el-table :data="statusData.tableData" style="height:72%; width: 100%; margin-bottom: 5px">
    ...
    <el-table-column prop="acid" label="饰品id" width="80" />
    <el-table-column prop="guser" label="购买用户" width="100" />
    <el-table-column prop="username" label="用户姓名" width="100" />
    <el-table-column prop="phone" label="手机号" width="130" />
    <el-table-column prop="address" label="收货账号" width="150" />
    <el-table-column prop="register_date" label="订单注册数据" width="180" />
    <el-table-column prop="status" label="订单状态" width="80" />
    <el-table-column fixed="right" label="数据操作" width="160">
      <template #default="scope">
        <el-button link type="primary" size="small" @click="update_type(scope.row)">同意订单</el-button>
        <el-popconfirm
            width="10"
        ...
        >
          <template #reference>
            <el-button link type="primary" size="small">拒绝订单</el-button>
          </template>
        </el-popconfirm>
      </template>
    </el-table-column>
...
const fresh = () =>{
  ...
  request.get("/order/findPage_Forder", {
    params: {
